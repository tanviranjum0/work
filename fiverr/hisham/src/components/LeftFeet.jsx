...
const Feet = () => {
    ...
    return (
        <div className="flex justify-center items-center">
            <div className="relative feet -scale-x-100 border mt-10 bg-gray-400 h-[589px] w-[390px] p-5">
