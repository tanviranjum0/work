...
const Left1 = () => {
    const { rightFootZone, increaseRightFootPain } = useContext(StoreContext);
    useEffect(() => {
    ...
    const handleClick = async (e) => {
        increaseRightFootPain(e.target.getAttribute("id"));
    };
    ...
    return (
        <div className="flex justify-center items-center">
            <div className="relative  -scale-x-100 left1bg border mt-10 bg-white h-[589px] w-[390px] p-5">
