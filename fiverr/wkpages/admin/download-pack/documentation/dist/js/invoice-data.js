...
$(document).ready(function() {
	...
	if ($("#datable_1").length > 0) {
		...
		var targetDt = $('#datable_1').DataTable({
			"dom": '<"row"<"col-sm-12 col-md-6"<"invoice-toolbar-left">><"col-sm-12 col-md-6"<"invoice-toolbar-right"flip>>><"row"<"col-sm-12"t>><"row"<"col-sm-12 col-md-5"i><"col-sm-12 col-md-7"p>>',
			responsive: true,
			autoWidth: false,
			"ordering": true,
			"columnDefs": [ {
