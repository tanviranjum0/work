...
$(document).ready(function () {
	...
	$(document).on('click', '.add-new-row', function (e) {
		$('.invoice-table tbody').append('<tr class="hk-table-space"><td></td></tr><tr><td class="w-70 border-top-left-radius border-right-0 border-bottom-0"><input type="text" class="form-control transparent-input" placeholder="Item Title"></td><td class="border-right-0 border-bottom-0"><input type="text" class="form-control transparent-input qty" value="0"></td><td class="w-15 border-right-0 border-bottom-0"><input type="text" class="form-control transparent-input price" value="0"></td><td class="border-right-0 border-bottom-0"><input type="text" class="form-control transparent-input discount" value="0"></td><td class="border-right-0 border-bottom-0"><select class="form-control custom-select disc-type transparent-input"><option value="1">%</option><option value="2">₹</option></select></td><td class="w-20 border-bottom-right-radius border-top-right-radius  bg-theme-light-5" rowspan="2"><input type="text" class="form-control transparent-input total" value="0" readonly><button type="button" class="close-row btn-close"><span aria-hidden="true">×</span></button></td></tr><tr><td colspan="5" class="border-bottom-left-radius border-right-0"><input type="text" class="form-control transparent-input" placeholder="Item Description"></td></tr>"></td></tr>');
		return false;
	});
