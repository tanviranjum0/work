...
$(function() {
	...
	$('.gallery-body  .collapse-simple .col > a').each(function(){
		$('<div class="form-check form-check-lg form-check-theme"><input type="checkbox" class="form-check-input check-select" id="chk_sel_'+tdCnt+'"><label class="form-check-label" for="chk_sel_'+tdCnt+'"></label></div>').appendTo($(this));
		tdCnt++;
	});
});
