...
const Test4 = () => {
  ...
  const [base64ToFile, setBase64ToFile] = useState(null);

  const handleBinarytoImage = (base64String, mimeType, fileName) => {
...
Sr9w4jatKm+38z//Z`; // Replace with your actual Base64 string
  ...
  return (
    <div className="bg-amber-400 h-[100vh] flex justify-center items-center">
      ...
      <button className="p-3 bg-cyan-300 rounded" onClick={handleBinarytoImage}>
        Display String
      </button>
    </div>
  );
