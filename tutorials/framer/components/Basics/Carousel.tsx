...
const Item = React.forwardRef<HTMLDivElement, ItemProps>(function (
  ...
  return (
    <motion.div
      ref={ref}
      className=" shrink-0 grow-1 basis-[100%] bg-white"
    ...
    >
      <div className="flex p-2 bg-lime-200" onClick={handleOnClick}>
        <div className="0">
          <p className="font-bold grow mr-4">{data.name}</p>
          <p>{data.vicinity}</p>
          <p>{data.address}</p>
        </div>
        <div className="">
          <p className="grow mr-4">{data.distance}</p>
          <p>{data.duration}</p>
        </div>
      </div>

      <div className="item-lower flex justify-center items-center px-4 py-2">
        <button className="button appearance-none bg-white my-1 border-none flex justify-center items-center flex-col">
          <span className="block border border-black rounded-full w-[65px] h-[65px] m-1" />
          One
        </button>
        <button className="button appearance-none bg-white my-1 border-none flex justify-center items-center flex-col">
          <span className="block border border-black rounded-full w-[65px] h-[65px] m-1" />
