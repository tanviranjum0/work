...
import "@/components/buttons/day9.css"; // Ensure you have the corresponding CSS file for styles
const Day9 = () => {
  return (
    <div className="h-screen flex justify-center items-center bg-orange-200">
