          ...
          <motion.div style={{ x: xPercentage }} className="flex">
            {images.map((image, i) => (
              <motion.div
                ...
                className=" h-screen max-h-[70vh] w-[80vw] flex-shrink-0 object-cover"
              >
                <Image
                  className="h-full object-cover"
                  quality={100}
                  fill={true}
                  src="https://media.istockphoto.com/id/1368242984/photo/canada-flag-waving-in-ottawa.jpg?s=1024x1024&w=is&k=20&c=ZNZ5ta-pWdafhjlNJtbHci2KztsUXcc8d5wBM6jI-xA="
                  alt={image}
                />
              </motion.div>
            ))}
      ...
      >
        {images.map((image, i) => (
          ...
          >
            <Image
              src={
                "https://media.istockphoto.com/id/1368242984/photo/canada-flag-waving-in-ottawa.jpg?s=1024x1024&w=is&k=20&c=ZNZ5ta-pWdafhjlNJtbHci2KztsUXcc8d5wBM6jI-xA="
              }
              alt={image}
              className="h-full object-cover"
            />
