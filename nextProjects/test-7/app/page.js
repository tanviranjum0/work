// import Carousel from "./components/carousel1/carousel1";
import Image from "next/image";
import Carousel from "./components/carousel1/Carousel1";
import AppleAnimation from "./components/AppleAnimation/AppleAnimation";
// import Hero from "./components/onScrollReveal/Hero";
const page = () => {
  return (
    <div className="flex bg-[#111]  flex-col ">
      {/* <Carousel /> */}
      <AppleAnimation />
      {/* <Image  src="./components/carousel1/images/1.jpg" alt="" /> */}
    </div>
  );
};
