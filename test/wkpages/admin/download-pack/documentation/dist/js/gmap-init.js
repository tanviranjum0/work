...
if( $('#map_canvas').length > 0 ){	
	 // When the window has finished loading create our google map below
		...
		function init() {
			...
			'<div class="infowindow-body"><p class="txt-dark mb-3">121 King Street, <br>Melbourne VIC 3000, Australia</p><a href="https://Templatemonster.com/" >www.Templatemonster.com</a></div>'+
			'</div>';
