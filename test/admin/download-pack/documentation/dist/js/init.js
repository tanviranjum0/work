...
var jampack = function(){
	...
	$(document).on('click', '[data-layout="vertical"] .navbar-toggle', function (e) {
		if(($wrapper).attr('data-layout-style')=='default') {
			...
			$(this).find('.toggle-icon').toggleClass('d-xl-none');
		}
...
var chatApp = function() {
	...
	$(document).on("click",".chatapp-wrap .chatapp-content .chatapp-aside .aside-body .chat-list .hk-media",function (e) {
		if(width<=991) {
	...
	if($('.chatapp-wrap #chat_body').length > 0) {
		...
		$(document).on('click', '.chat-list > .list-group-item > div.hk-media', function (e){
			$('.chat-list > .list-group-item > div.hk-media').removeClass('active-user');
		...
		$(document).on("keypress","#input_msg_send_chatapp",function (e) {
			if ((e.which == 13)&&(!$(this).val().length == 0)) {
				$('<li class="hk-media sent"><div class="hk-media-body"><div class="msg-box"><div><p>' + $(this).val() + '</p><span class="chat-time">7:57 PM</span></div><div class="msg-action"><a href="#" class="btn btn-icon btn-flush-charcoal btn-rounded flush-soft-hover no-caret"><span class="btn-icon-wrap"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-corner-up-right"><polyline points="15 14 20 9 15 4"></polyline><path d="M4 20v-7a4 4 0 0 1 4-4h12"></path></svg></span></span></a><a href="#" class="btn btn-icon btn-flush-charcoal btn-rounded flush-soft-hover dropdown-toggle no-caret" data-bs-toggle="dropdown"><span class="btn-icon-wrap"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg></span></span></a><div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item ml-0" href="#">Forward</a><a class="dropdown-item ml-0" href="#">Copy</a></div></div></div></div></div></li>').appendTo(".chatapp-single-chat  ul.list-unstyled");
				$(this).val('');
				demoScroll.scrollTo({ top: 100000, behavior: "smooth" });
				setTimeout(function(){
					$('<li class="hk-media received"><div class="avatar avatar-xs"><img src="dist/img/avatar2.jpg" alt="user" class="avatar-img rounded-circle"></div><div class="hk-media-body"><div class="msg-box"><div><p>What are you saying?</p><span class="chat-time">10:55 AM</span></div><div class="msg-action"><a href="#" class="btn btn-icon btn-flush-charcoal btn-rounded flush-soft-hover no-caret"><span class="btn-icon-wrap"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-corner-up-right"><polyline points="15 14 20 9 15 4"></polyline><path d="M4 20v-7a4 4 0 0 1 4-4h12"></path></svg></span></span></a><a href="#" class="btn btn-icon btn-flush-charcoal btn-rounded flush-soft-hover dropdown-toggle no-caret" data-bs-toggle="dropdown"><span class="btn-icon-wrap"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg></span></span></a><div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item ml-0" href="#">Forward</a><a class="dropdown-item ml-0" href="#">Copy</a></div></div></div></div></div></li>').appendTo(".chatapp-single-chat .chat-body ul.list-unstyled");
					demoScroll.scrollTo({ top: 100000, behavior: "smooth" });
				},1000);
			} else if(e.which == 13) {
		...
		$(document).on("click",".chat-footer .btn-send",function (e) {
				...
				$('<li class="hk-media sent"><div class="hk-media-body"><div class="msg-box"><div><p>' + targetInput.val() + '</p><span class="chat-time">7:57 PM</span></div><div class="msg-action"><a href="#" class="btn btn-icon btn-flush-charcoal btn-rounded flush-soft-hover no-caret"><span class="btn-icon-wrap"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-corner-up-right"><polyline points="15 14 20 9 15 4"></polyline><path d="M4 20v-7a4 4 0 0 1 4-4h12"></path></svg></span></span></a><a href="#" class="btn btn-icon btn-flush-charcoal btn-rounded flush-soft-hover dropdown-toggle no-caret" data-bs-toggle="dropdown"><span class="btn-icon-wrap"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg></span></span></a><div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item ml-0" href="#">Forward</a><a class="dropdown-item ml-0" href="#">Copy</a></div></div></div></div></div></li>').appendTo(".chatapp-single-chat  ul.list-unstyled");
				targetInput.val('');
				demoScroll.scrollTo({ top: 100000, behavior: "smooth" });
				setTimeout(function(){
					$('<li class="hk-media received"><div class="avatar avatar-xs"><img src="dist/img/avatar2.jpg" alt="user" class="avatar-img rounded-circle"></div><div class="hk-media-body"><div class="msg-box"><div><p>What are you saying?</p><span class="chat-time">10:55 AM</span></div><div class="msg-action"><a href="#" class="btn btn-icon btn-flush-charcoal btn-rounded flush-soft-hover no-caret"><span class="btn-icon-wrap"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-corner-up-right"><polyline points="15 14 20 9 15 4"></polyline><path d="M4 20v-7a4 4 0 0 1 4-4h12"></path></svg></span></span></a><a href="#" class="btn btn-icon btn-flush-charcoal btn-rounded flush-soft-hover dropdown-toggle no-caret" data-bs-toggle="dropdown"><span class="btn-icon-wrap"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg></span></span></a><div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item ml-0" href="#">Forward</a><a class="dropdown-item ml-0" href="#">Copy</a></div></div></div></div></div></li>').appendTo(".chatapp-single-chat .chat-body ul.list-unstyled");
	...
	if($('.hk-chat-popup .chat-popup-body').length > 0) {
		...
		$(document).on("keypress","#input_msg_chat_popup",function (e) {
			if ((e.which == 13)&&(!$(this).val().length == 0)) {
				$('<li class="hk-media sent"><div class="hk-media-body"><div class="msg-box"><div><p>' + $(this).val() + '</p> <span class="chat-time">7:57 PM</span><div class="msg-action"><a href="#" class="btn btn-sm btn-icon btn-flush-charcoal btn-rounded flush-soft-hover dropdown-toggle no-caret" data-bs-toggle="dropdown"><span class="btn-icon-wrap"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg></span></span></a><div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#">Reply</a><a class="dropdown-item" href="#">Forward</a><a class="dropdown-item" href="#">Copy</a></div></div></div></div></div></div></li>').appendTo(".hk-chat-popup  ul.list-unstyled");
				$(this).val('');
				demoScroll.scrollTo({ top: 100000, behavior: "smooth" });
				setTimeout(function(){
					$('.typing-wrap').remove();
					$('<li class="hk-media received"><div class="avatar avatar-xs"> <img src="dist/img/avatar8.jpg" alt="user" class="avatar-img rounded-circle"></div><div class="hk-media-body"><div class="msg-box"><div><p>What are you saying?</p><span class="chat-time">10:55 AM</span><div class="msg-action"><a href="#" class="btn btn-sm btn-icon btn-flush-charcoal btn-rounded flush-soft-hover dropdown-toggle no-caret" data-bs-toggle="dropdown"><span class="btn-icon-wrap"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg></span></span></a><div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#">Reply</a><a class="dropdown-item" href="#">Forward</a><a class="dropdown-item" href="#">Copy</a></div></div></div></div></div></div></li>').appendTo(".hk-chat-popup .chat-popup-body ul.list-unstyled");
					demoScroll.scrollTo({ top: 100000, behavior: "smooth" });
				},1000);
			} else if(e.which == 13) {
				alert('Please type somthing!');
	...
	if($('.hk-chatbot-popup .chatbot-popup-body').length > 0) {
		...
		$(document).on("keypress","#input_msg_chat_popup",function (e) {
			if ((e.which == 13)&&(!$(this).val().length == 0)) {
				$('<li class="hk-media sent"><div class="hk-media-body"><div class="msg-box"><div><p>' + $(this).val() + '</p> </div></div></div></li>').appendTo(".hk-chatbot-popup  ul.list-unstyled");
				$(this).val('');
				demoScroll.scrollTo({ top: 100000, behavior: "smooth" });
				setTimeout(function(){
					$('.typing-wrap').remove();
					$('<li class="hk-media received"><div class="avatar avatar-xs"><span class="avatar-icon avatar-icon-inv-info rounded-circle"><span class="initial-wrap"><span><i class="ri-customer-service-2-line"></i></span></span></span></div><div class="hk-media-body"><div class="msg-box"><div><p>What are you saying?</p></div></div></div></li>').appendTo(".hk-chatbot-popup .chatbot-popup-body ul.list-unstyled");
					demoScroll.scrollTo({ top: 100000, behavior: "smooth" });
				},1000);
			} else if(e.which == 13) {
				alert('Please type somthing!');
...
var emailApp = function() {
	...
	$(document).on("click",".emailapp-wrap .emailapp-content .emailapp-aside .aside-body .email-list .hk-media",function (e) {
		if(width<=991) {
	...
	$(document).on("click",".show-compose-popup",function (e) {
		...
		$('#max_compose_popup').find('.feather-icon:first-child').removeClass('d-none');	
		$('#max_compose_popup').find('.feather-icon:last-child').addClass('d-none');	
		return false;
	});
	$(document).on("click","#min_compose_popup",function (e) {
		...
		$('#max_compose_popup').find('.feather-icon').toggleClass('d-none');
		return false;
	});
	...
	$(document).on("click","#max_compose_popup .feather-maximize-2",function (e) {
	...
	$(document).on("click",".mail-desc-dropdown .dropdown-toggle",function (e) {
	...
	$(document).on("click",'#del_event',function (e) {
		...
		Swal.fire({
		  ...
		  if (result.value) {
			...
			Swal.fire({
				html:
				'<div class="d-flex align-items-center"><i class="ri-delete-bin-5-fill me-15 font-24 text-danger"></i><h5 class="text-danger mb-0">Event has been deleted!</h5></div>',
				timer: 2000,
				customClass: {
...
$(document).on("show.bs.collapse",".more-content-block .collapse",function (e) {
	...
	$('.more-content-block .more-content-toggle span:first-child').addClass('d-none');	
	$('.more-content-block .more-content-toggle span:last-child').removeClass('d-none');	
});
$(document).on("hide.bs.collapse",".more-content-block .collapse",function (e) {
	...
	$('.more-content-block .more-content-toggle span:first-child').removeClass('d-none');
	$('.more-content-block .more-content-toggle span:last-child').addClass('d-none');
});
